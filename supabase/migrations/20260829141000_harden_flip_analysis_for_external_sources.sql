...
begin
  ...
  set market_price_m2 = round(s.median_price_m2::numeric, 2),
      ...
      analysis_note = 'Benchmark: mediana cen ofertowych podobnych mieszkań 25–60 m² / 1–3 pokoje w tej samej miejscowości. Cena sprzedaży: 98% mediany. Rezerwa kosztowa: 3–5% ceny sprzedaży. Remont: heurystyka na podstawie opisu oferty.',
      flip_match = coalesce((
